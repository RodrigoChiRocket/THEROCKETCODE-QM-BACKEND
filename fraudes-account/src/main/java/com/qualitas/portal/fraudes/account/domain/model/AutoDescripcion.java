...
public class AutoDescripcion {
    ...
    public AutoDescripcion() {}

    // Constructor con parámetros
    public AutoDescripcion(BigDecimal iCatalogoAutoDescripcionId, BigDecimal iModeloId, String vDescripcion, Date dFechaCreacion, BigDecimal iUsuarioCreacion) {
